      ...
      builder: (ctx, setDialogState) => Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                existing != null ? l10n.editPass : l10n.addPass,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  label: requiredLabel(l10n.passName),
